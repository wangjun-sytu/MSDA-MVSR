...
center_list = [11 19 7]; 
class_id = [0 1 2];
trainOptions.maxClassSizes = [10, 10, 10];
...
% remove subjects with invalid labels, -1 and 3
...
cmd = 'test_MSLRDA_MMD_MVSRC_FC_PBFCT_11_19_7_AGE_LE18_CV';
savefile = ['MSLRDA_MMD_MVSRC_FC_PBFCT_MultiClass_11_19_7_AGE_LE18_' ts '.mat'];
