...
ds=load('fMRI_FC_PBFCT_MultiClass_AGE_LE18.mat');
...
valid_ind = labels_all~=-1; valid_ind_C = mat2cell(valid_ind,task_sizes,1);
...
cmd = 'test_MSLRDA_MMD_MVSRC_FC_PBFCT_7_11_16_19_3_AGE_LE18_CV';
savefile = ['MSLRDA_MMD_MVSRC_FC_PBFCT_MultiClass_7_11_16_19_3_AGE_LE18_' ts '.mat'];
